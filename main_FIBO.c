...
// Pen control states (from G-code M15/M16 commands)
typedef enum {
	PEN_UP = 0, PEN_DOWN = 1
} PenState;
...
//	}
	...
	if (abs(pid->error_integral) < 0.02) {
		return output;
	}
...
void InitializeRevoluteTuning(void) {
	...
	revolute_tuning.max_velocity = 30.0f;
...
void InitializePrismaticTuning(void) {
	...
	prismatic_tuning.max_velocity = 30.0f;
...
void init_trapezoidal(Trajectory *trj, float init_pos, float final_pos) {
	...
	if (trj->delta_pos >= s_total_accel_decel) {
		...
		trj->peak_velocity = trj->desire_av;
...
void generate_trapezoidal(Trajectory *trj) {
	...
	if (trj->profile_type == PROFILE_TRIANGULAR) {
		// TRIANGULAR PROFILE IMPLEMENTATION
...
// Move functions with enhanced trajectory generation
...
//		prismatic_cascade.velocity_setpoint = -revolute_velocity;
//		is_prismatic_compensating = true;
//		prismatic_encoder.position = prismatic_encoder.position +revolute_encoder.position;
//	} else {
//		prismatic_encoder.position = prismatic_encoder.position +revolute_encoder.position;
//		is_prismatic_compensating = false;
//	}
...
// Enhanced prismatic control loop with trajectory integration
...
void MoveToCartesianPositionSTM32(float x, float y) {
	...
	// Use your existing trajectory functions
	SetTrajectoryParameters(&revolute_trajectory, revolute_velocity, 0.4f);
	SetTrajectoryParameters(&prismatic_trajectory, prismatic_velocity, 20.0f);
...
static RobotWriteCommand fibo_g08_commands[] = {
// Letter F - First stroke (vertical line)
		{ 0.104, 0.164, PEN_DOWN, 0 },  // Start F
		{ 0.104, 0.186, PEN_DOWN, 0 },  // Top of F
		{ 0.102, 0.186, PEN_DOWN, 0 },  // Top horizontal start
		{ 0.102, 0.186, PEN_DOWN, 0 },  // Top horizontal end
		{ 0.102, 0.176, PEN_DOWN, 0 },  // Middle horizontal start
		{ 0.100, 0.176, PEN_DOWN, 0 },  // Middle horizontal end

		// Move to letter I
		{ 0.106, 0.164, PEN_UP, 1 },    // Rapid move to I

		// Letter I
		{ 0.106, 0.164, PEN_DOWN, 0 },  // Bottom line start
		{ 0.108, 0.164, PEN_DOWN, 0 },  // Bottom line end
		{ 0.107, 0.164, PEN_DOWN, 0 },  // Move to center
		{ 0.107, 0.186, PEN_DOWN, 0 },  // Vertical line
		{ 0.106, 0.186, PEN_DOWN, 0 },  // Top line start
		{ 0.108, 0.186, PEN_DOWN, 0 },  // Top line end

		// Move to letter B
		{ 0.110, 0.164, PEN_UP, 1 },    // Rapid move to B

		// Letter B
		{ 0.110, 0.164, PEN_DOWN, 0 },  // Start B
		{ 0.110, 0.186, PEN_DOWN, 0 },  // Vertical line
		{ 0.114, 0.186, PEN_DOWN, 0 },  // Top horizontal
		{ 0.114, 0.182, PEN_DOWN, 0 },  // Right side top
		{ 0.111, 0.176, PEN_DOWN, 0 },  // Middle connection
		{ 0.114, 0.176, PEN_DOWN, 0 },  // Middle horizontal
		{ 0.114, 0.167, PEN_DOWN, 0 },  // Right side bottom
		{ 0.110, 0.164, PEN_DOWN, 0 },  // Close B

		// Move to letter O
		{ 0.117, 0.164, PEN_UP, 1 },    // Rapid move to O

		// Letter O
		{ 0.117, 0.167, PEN_DOWN, 0 },  // Start O
		{ 0.117, 0.182, PEN_DOWN, 0 },  // Left side
		{ 0.121, 0.186, PEN_DOWN, 0 },  // Top curve
		{ 0.125, 0.182, PEN_DOWN, 0 },  // Right side top
		{ 0.125, 0.167, PEN_DOWN, 0 },  // Right side bottom
		{ 0.121, 0.164, PEN_DOWN, 0 },  // Bottom curve
		{ 0.117, 0.167, PEN_DOWN, 0 },  // Close O

		// Underscore
		{ 0.128, 0.154, PEN_UP, 1 },    // Move to underscore
		{ 0.128, 0.154, PEN_DOWN, 0 },  // Underscore start
		{ 0.135, 0.154, PEN_DOWN, 0 },  // Underscore end

		// Move to letter G
		{ 0.138, 0.164, PEN_UP, 1 },    // Rapid move to G

		// Letter G
		{ 0.142, 0.176, PEN_DOWN, 0 },  // Start G
		{ 0.141, 0.186, PEN_DOWN, 0 },  // Top curve
		{ 0.138, 0.182, PEN_DOWN, 0 },  // Left side top
		{ 0.138, 0.167, PEN_DOWN, 0 },  // Left side bottom
		{ 0.141, 0.164, PEN_DOWN, 0 },  // Bottom curve
		{ 0.142, 0.167, PEN_DOWN, 0 },  // Right side start
		{ 0.141, 0.176, PEN_DOWN, 0 },  // Horizontal line

		// Move to number 0
		{ 0.145, 0.164, PEN_UP, 1 },    // Rapid move to 0

		// Number 0
		{ 0.145, 0.167, PEN_DOWN, 0 },  // Start 0
		{ 0.145, 0.182, PEN_DOWN, 0 },  // Left side
		{ 0.149, 0.186, PEN_DOWN, 0 },  // Top curve
		{ 0.153, 0.182, PEN_DOWN, 0 },  // Right side top
		{ 0.153, 0.167, PEN_DOWN, 0 },  // Right side bottom
		{ 0.149, 0.164, PEN_DOWN, 0 },  // Bottom curve
		{ 0.145, 0.167, PEN_DOWN, 0 },  // Close 0

		// Move to number 8
		{ 0.156, 0.164, PEN_UP, 1 },    // Rapid move to 8

		// Number 8
		{ 0.158, 0.176, PEN_DOWN, 0 },  // Start middle of 8
		{ 0.156, 0.182, PEN_DOWN, 0 },  // Top left curve
		{ 0.158, 0.186, PEN_DOWN, 0 },  // Top center
		{ 0.160, 0.182, PEN_DOWN, 0 },  // Top right curve
		{ 0.158, 0.176, PEN_DOWN, 0 },  // Back to middle
		{ 0.156, 0.167, PEN_DOWN, 0 },  // Bottom left curve
		{ 0.158, 0.164, PEN_DOWN, 0 },  // Bottom center
		{ 0.160, 0.167, PEN_DOWN, 0 },  // Bottom right curve
		{ 0.158, 0.176, PEN_DOWN, 0 },  // Back to middle

		// End of pattern
		{ 0.165, 0.176, PEN_UP, 1 }     // Final position
};
...
void WriteFIBO_G08_FromGcode(void) {
	static uint32_t last_move_time = 0;
	static uint16_t command_index = 0;
	static uint8_t pen_servo_commanded = 0;

	if (IsCoordinatedMoveComplete()
			&& (HAL_GetTick() - last_move_time > 2000)) {
		if (command_index < FIBO_COMMANDS_COUNT) {
			RobotWriteCommand current_command = fibo_g08_commands[command_index];

			// Handle pen control (servo control for your system)
			if (current_command.pen_state == PEN_DOWN && !pen_servo_commanded) {
				// Lower pen - use your servo control
				main_servo = 1;  // Your pen down command
				pen_servo_commanded = 1;
				// Add small delay for pen movement
				last_move_time = HAL_GetTick() + 500;
				return;
			} else if (current_command.pen_state == PEN_UP
					&& pen_servo_commanded) {
				// Raise pen - use your servo control
				main_servo = 2;  // Your pen up command
				PWM_set = 400;   // Adjust PWM value as needed
				pen_servo_commanded = 0;
				// Add small delay for pen movement
				last_move_time = HAL_GetTick() + 500;
				return;
			}
			...
			if (ValidateCartesianTarget(current_command.x, current_command.y)) {
				// Execute movement using your inverse kinematics
				MoveToCartesianPositionSTM32(current_command.x,
						current_command.y);
			...
			// Adjust timing based on move type
			uint32_t move_delay = current_command.is_move_only ? 1000 : 2500;
			last_move_time = HAL_GetTick() + move_delay;

		} else {
			// Writing complete
			command_index = 0;
			pen_servo_commanded = 0;
			main_servo = 2;  // Ensure pen is up
			PWM_set = 400;

			// Optional: Add longer pause before restarting
			last_move_time = HAL_GetTick() + 5000; // 5 second pause
		}
	}
}
...
//		{0.000000f, 0.010000f},{0.000000f, 0.000000f},
		...
		// Letter F (offset)
		{0.000000f, -0.200000f},
		{0.009444f, -0.200000f},{0.018889f, -0.200000f},
		{0.028333f, -0.200000f},{0.037778f, -0.200000f},
		{0.047222f, -0.200000f},{0.056667f, -0.200000f},
		{0.066111f, -0.200000f},{0.075556f, -0.200000f},
		{0.085000f, -0.200000f},
		{0.085000f, -0.200000f},{0.085000f, -0.195556f},
		{0.085000f, -0.191111f},{0.085000f, -0.186667f},
		{0.085000f, -0.182222f},{0.085000f, -0.177778f},
		{0.085000f, -0.173333f},{0.085000f, -0.168889f},
		{0.085000f, -0.164444f},{0.085000f, -0.160000f},

		{0.083333f, -0.160000f},{0.081667f, -0.160000f},
		{0.080000f, -0.160000f},{0.078333f, -0.160000f},
		{0.076667f, -0.160000f},{0.075000f, -0.160000f},
		{0.073333f, -0.160000f},{0.071667f, -0.160000f},

		{0.070000f, -0.160000f},{0.070000f, -0.163333f},
		{0.070000f, -0.166667f},{0.070000f, -0.170000f},
		{0.070000f, -0.173333f},{0.070000f, -0.176667f},
		{0.070000f, -0.180000f},{0.070000f, -0.183333f},
		{0.070000f, -0.186667f},{0.070000f, -0.190000f},

		{0.068333f, -0.190000f},{0.066667f, -0.190000f},
		{0.065000f, -0.190000f},{0.063333f, -0.190000f},
		{0.061667f, -0.190000f},{0.060000f, -0.190000f},
		{0.058333f, -0.190000f},{0.056667f, -0.190000f},
		{0.055000f, -0.190000f},{0.055000f, -0.186667f},
		{0.055000f, -0.183333f},{0.055000f, -0.180000f},
		{0.055000f, -0.176667f},{0.055000f, -0.173333f},
		{0.055000f, -0.170000f},{0.055000f, -0.166667f},
		{0.055000f, -0.163333f},{0.055000f, -0.160000f},
		{0.053333f, -0.160000f},{0.051667f, -0.160000f},
		{0.050000f, -0.160000f},{0.048333f, -0.160000f},
		{0.046667f, -0.160000f},{0.045000f, -0.160000f},
		{0.043333f, -0.160000f},{0.041667f, -0.160000f},
		{0.040000f, -0.160000f},{0.040000f, -0.163333f},
		{0.040000f, -0.166667f},{0.040000f, -0.170000f},
		{0.040000f, -0.173333f},{0.040000f, -0.176667f},
		{0.040000f, -0.180000f},{0.040000f, -0.183333f},
		{0.040000f, -0.186667f},{0.040000f, -0.190000f},
		{0.035556f, -0.190000f},{0.031111f, -0.190000f},
		{0.026667f, -0.190000f},{0.022222f, -0.190000f},
		{0.017778f, -0.190000f},{0.013333f, -0.190000f},
		{0.008889f, -0.190000f},{0.004444f, -0.190000f},
...
//		{0.000000f, 0.060000f},{0.000000f, 0.050000f},
		...
		// Letter I(offset)
		{0.009444f, -0.150000f},{0.018889f, -0.150000f},
		{0.028333f, -0.150000f},{0.037778f, -0.150000f},
		{0.047222f, -0.150000f},{0.056667f, -0.150000f},
		{0.066111f, -0.150000f},{0.075556f, -0.150000f},
		{0.085000f, -0.150000f},{0.085000f, -0.147778f},
		{0.085000f, -0.145556f},{0.085000f, -0.143333f},
		{0.085000f, -0.141111f},{0.085000f, -0.140000f},
		{0.075556f, -0.140000f},{0.066111f, -0.140000f},
		{0.056667f, -0.140000f},{0.047222f, -0.140000f},
		{0.037778f, -0.140000f},{0.028333f, -0.140000f},
		{0.018889f, -0.140000f},{0.009444f, -0.140000f},
		{0.000000f, -0.140000f},{0.000000f, -0.150000f},
...
//		,{0.01f, 0.08f},{0.0f, 0.08f},
		...
		{0.000000f, -0.130000f},
		// Letter B(offset)
		{0.009444f, -0.130000f},{0.018889f, -0.130000f},
		{0.028333f, -0.130000f},{0.037778f, -0.130000f},
		{0.047222f, -0.130000f},{0.056667f, -0.130000f},
		{0.066111f, -0.130000f},{0.075556f, -0.130000f},
		{0.085000f, -0.130000f},{0.085000f, -0.120000f},{0.085000f, -0.110000f},
		{0.085000f, -0.100000f},
		{0.085000f, -0.090000f},{0.063750f, -0.080000f},{0.042500f, -0.090000f},{0.021250f, -0.080000f},{0.000000f, -0.090000f},{0.000000f, -0.130000f},
		//Inner letter B (offset)
		{0.000000f, -0.120000f},{0.010000f, -0.120000f},
		{0.020000f, -0.120000f},{0.030000f, -0.120000f},
		{0.040000f, -0.120000f},{0.050000f, -0.120000f},
		{0.060000f, -0.120000f},{0.070000f, -0.120000f},
		{0.070000f, -0.100000f},{0.060000f, -0.100000f},
		{0.055000f, -0.100000f},{0.050000f, -0.120000f},
		{0.038000f, -0.120000f},{0.040000f, -0.110000f},
		{0.035000f, -0.100000f},{0.020000f, -0.100000f},
		{0.015000f, -0.110000f},
		{0.010000f, -0.120000f},{0.000000f, -0.120000f},
...
//		{0.000000f, 0.120000f},
		...
		{0.000000f, -0.070000f},{0.004444f, -0.070000f},
		{0.008889f, -0.070000f},{0.013333f, -0.070000f},
		{0.017778f, -0.070000f},{0.022222f, -0.070000f},
		{0.026667f, -0.070000f},{0.031111f, -0.070000f},
		{0.035556f, -0.070000f},{0.040000f, -0.070000f},
		{0.044444f, -0.070000f},{0.048889f, -0.070000f},
		{0.053333f, -0.070000f},{0.057778f, -0.070000f},
		{0.062222f, -0.070000f},{0.066667f, -0.070000f},
		{0.071111f, -0.070000f},{0.075556f, -0.070000f},
		{0.080000f, -0.070000f},{0.085000f, -0.070000f},
		// Right side going up (offset)
		{0.085000f, -0.065556f},{0.085000f, -0.061111f},
		{0.085000f, -0.056667f},{0.085000f, -0.052222f},
		{0.085000f, -0.047778f},{0.085000f, -0.043333f},
		{0.085000f, -0.038889f},{0.085000f, -0.034444f},
		{0.085000f, -0.030000f},
		// Top edge going left (offset)
		{0.080000f, -0.030000f},{0.075556f, -0.030000f},
		{0.071111f, -0.030000f},{0.066667f, -0.030000f},
		{0.062222f, -0.030000f},{0.057778f, -0.030000f},
		{0.053333f, -0.030000f},{0.048889f, -0.030000f},
		{0.044444f, -0.030000f},{0.040000f, -0.030000f},
		{0.035556f, -0.030000f},{0.031111f, -0.030000f},
		{0.026667f, -0.030000f},{0.022222f, -0.030000f},
		{0.017778f, -0.030000f},{0.013333f, -0.030000f},
		{0.008889f, -0.030000f},{0.004444f, -0.030000f},
		{0.000000f, -0.030000f},
		// Left side going down (offset)
		{0.000000f, -0.034444f},{0.000000f, -0.038889f},
		{0.000000f, -0.043333f},{0.000000f, -0.047778f},
		{0.000000f, -0.052222f},{0.000000f, -0.056667f},
		{0.000000f, -0.061111f},{0.000000f, -0.065556f},
		{0.000000f, -0.070000f},
		// Inner hole - move to inner starting point (offset)
		{0.020000f, -0.060000f},
		// Inner outline (clockwise to create hole) (offset)
		{0.020000f, -0.055556f},{0.020000f, -0.051111f},
		{0.020000f, -0.046667f},{0.020000f, -0.042222f},
		{0.020000f, -0.040000f},{0.024444f, -0.040000f},
		{0.028889f, -0.040000f},{0.033333f, -0.040000f},
		{0.037778f, -0.040000f},{0.042222f, -0.040000f},
		{0.046667f, -0.040000f},{0.051111f, -0.040000f},
		{0.055556f, -0.040000f},{0.060000f, -0.040000f},
		{0.065000f, -0.040000f},{0.065000f, -0.042222f},
		{0.065000f, -0.046667f},{0.065000f, -0.051111f},
		{0.065000f, -0.055556f},{0.065000f, -0.060000f},
		{0.060000f, -0.060000f},{0.055556f, -0.060000f},
		{0.051111f, -0.060000f},{0.046667f, -0.060000f},
		{0.042222f, -0.060000f},{0.037778f, -0.060000f},
		{0.033333f, -0.060000f},{0.028889f, -0.060000f},
		{0.024444f, -0.060000f},{0.020000f, -0.060000f},
		{0.000000f, -0.060000f},
...
//		{0.000000f, 0.1700000f},{0.0000000f, 0.200000f},
		...
		//underscore (offset)
		{0.000000f, -0.020000f},{0.000000f, 0.0200000f},
...
//
		...
		{0.000000f, 0.030f },
		// Letter G (offset)
		{0.009444f, 0.030f},{0.018889f, 0.030f},
		{0.028333f, 0.030f},{0.037778f, 0.030f},
		{0.047222f, 0.030f},{0.056667f, 0.030f},
		{0.066111f, 0.030f},{0.075556f, 0.030f},
		{0.085000f, 0.030f},{0.085000f, 0.038f},
		{0.085000f, 0.046f},{0.085000f, 0.054f},
		{0.085000f, 0.062f},{0.085000f, 0.070f},
		{0.082000f, 0.070f},{0.079000f, 0.070f},
		{0.076000f, 0.070f},{0.073000f, 0.070f},
		{0.070000f, 0.070f},{0.070000f, 0.064f},
		{0.070000f, 0.058f},{0.070000f, 0.052f},
		{0.070000f, 0.046f},{0.070000f, 0.040f},
		{0.058000f, 0.040f},{0.046000f, 0.040f},
		{0.034000f, 0.040f},{0.022000f, 0.040f},
		{0.010000f, 0.040f},{0.010000f, 0.043f},
		{0.010000f, 0.046f},{0.010000f, 0.049f},
		{0.010000f, 0.052f},{0.010000f, 0.055f},
		{0.014000f, 0.055f},{0.018000f, 0.055f},
		{0.022000f, 0.055f},{0.026000f, 0.055f},
		{0.030000f, 0.055f},{0.030000f, 0.053f},
		{0.030000f, 0.051f},{0.030000f, 0.049f},
		{0.030000f, 0.047f},{0.030000f, 0.045f},
		{0.033000f, 0.045f},{0.036000f, 0.045f},
		{0.039000f, 0.045f},{0.042000f, 0.045f},
		{0.045000f, 0.045f},{0.045000f, 0.050f},
		{0.045000f, 0.055f},{0.045000f, 0.060f},
		{0.045000f, 0.065f},{0.045000f, 0.070f},
		{0.036000f, 0.070f},{0.027000f, 0.070f},
		{0.018000f, 0.070f},{0.009000f, 0.070f},
...
//		{0.024444f, 0.270000f},{0.020000f, 0.270000f},
		...
		{0.000000f, 0.080000f},{0.004444f, 0.080000f},
		{0.008889f, 0.080000f},{0.013333f, 0.080000f},
		{0.017778f, 0.080000f},{0.022222f, 0.080000f},
		{0.026667f, 0.080000f},{0.031111f, 0.080000f},
		{0.035556f, 0.080000f},{0.040000f, 0.080000f},
		{0.044444f, 0.080000f},{0.048889f, 0.080000f},
		{0.053333f, 0.080000f},{0.057778f, 0.080000f},
		{0.062222f, 0.080000f},{0.066667f, 0.080000f},
		{0.071111f, 0.080000f},{0.075556f, 0.080000f},
		{0.080000f, 0.080000f},{0.085000f, 0.080000f},
		// Right side going up
		{0.085000f, 0.084444f},{0.085000f, 0.088889f},
		{0.085000f, 0.093333f},{0.085000f, 0.097778f},
		{0.085000f, 0.102222f},{0.085000f, 0.106667f},
		{0.085000f, 0.111111f},{0.085000f, 0.115556f},
		{0.085000f, 0.120000f},
		// Top edge going left
		{0.080000f, 0.120000f},{0.075556f, 0.120000f},
		{0.071111f, 0.120000f},{0.066667f, 0.120000f},
		{0.062222f, 0.120000f},{0.057778f, 0.120000f},
		{0.053333f, 0.120000f},{0.048889f, 0.120000f},
		{0.044444f, 0.120000f},{0.040000f, 0.120000f},
		{0.035556f, 0.120000f},{0.031111f, 0.120000f},
		{0.026667f, 0.120000f},{0.022222f, 0.120000f},
		{0.017778f, 0.120000f},{0.013333f, 0.120000f},
		{0.008889f, 0.120000f},{0.004444f, 0.120000f},
		{0.000000f, 0.120000f},
		// Left side going down
		{0.000000f, 0.115556f},{0.000000f, 0.111111f},
		{0.000000f, 0.106667f},{0.000000f, 0.102222f},
		{0.000000f, 0.097778f},{0.000000f, 0.093333f},
		{0.000000f, 0.088889f},{0.000000f, 0.084444f},
		{0.000000f, 0.080000f},
		// Inner hole - move to inner starting point
		{0.020000f, 0.090000f},
		// Inner outline (clockwise to create hole)
		{0.020000f, 0.094444f},{0.020000f, 0.098889f},
		{0.020000f, 0.103333f},{0.020000f, 0.107778f},
		{0.020000f, 0.110000f},{0.024444f, 0.110000f},
		{0.028889f, 0.110000f},{0.033333f, 0.110000f},
		{0.037778f, 0.110000f},{0.042222f, 0.110000f},
		{0.046667f, 0.110000f},{0.051111f, 0.110000f},
		{0.055556f, 0.110000f},{0.060000f, 0.110000f},
		{0.065000f, 0.110000f},{0.065000f, 0.107778f},
		{0.065000f, 0.103333f},{0.065000f, 0.098889f},
		{0.065000f, 0.094444f},{0.065000f, 0.090000f},
		{0.060000f, 0.090000f},{0.055556f, 0.090000f},
		{0.051111f, 0.090000f},{0.046667f, 0.090000f},
		{0.042222f, 0.090000f},{0.037778f, 0.090000f},
		{0.033333f, 0.090000f},{0.028889f, 0.090000f},
		{0.024444f, 0.090000f},{0.020000f, 0.090000f},
...
//		{0.0525f, 0.14f},{0.075f, 0.14f},{0.075f, 0.16f},{0.0525f, 0.16f},{0.0525f, 0.14f},{0.01f, 0.14f},{0.0325f, 0.14f},{0.0325f, 0.16f},{0.01f, 0.16f},{0.01f, 0.14f},{0.0f, 0.14f},
		...
		//Number 8 (offset)
		{0.000000f, 0.160000f},{0.010000f, 0.170000f},
		{0.031667f, 0.170000f},{0.053333f, 0.170000f},
		{0.075000f, 0.170000f},{0.085000f, 0.160000f},
		{0.085000f, 0.153333f},{0.085000f, 0.146667f},
		{0.085000f, 0.140000f},{0.075000f, 0.130000f},
		{0.053333f, 0.130000f},{0.031667f, 0.130000f},
		{0.010000f, 0.130000f},{0.000000f, 0.140000f},
		//Inner number 8 (offset)
		{0.017500f, 0.140000f},{0.035000f, 0.140000f},
		{0.052500f, 0.140000f},{0.060000f, 0.140000f},
		{0.067500f, 0.140000f},{0.075000f, 0.140000f},
		{0.075000f, 0.146667f},{0.075000f, 0.153333f},
		{0.075000f, 0.160000f},{0.067500f, 0.160000f},
		{0.060000f, 0.160000f},{0.052500f, 0.160000f},
		{0.052500f, 0.153333f},{0.052500f, 0.146667f},
		{0.052500f, 0.140000f},{0.038333f, 0.140000f},
		{0.024167f, 0.140000f},{0.010000f, 0.140000f},
		{0.017500f, 0.140000f},{0.025000f, 0.140000f},
		{0.032500f, 0.140000f},{0.032500f, 0.146667f},
		{0.032500f, 0.153333f},{0.032500f, 0.160000f},
		{0.025000f, 0.160000f},{0.017500f, 0.160000f},
		{0.010000f, 0.160000f},{0.010000f, 0.153333f},
		{0.010000f, 0.146667f},{0.010000f, 0.140000f},
		{0.006667f, 0.140000f},{0.003333f, 0.140000f},
		{0.000000f, 0.140000f}
};
...
void WriteFIBO_G08_Pattern(void) {
    static uint32_t last_move_time = 0;
    static uint8_t point_index = 0;
    static const uint8_t total_points = sizeof(FIBO_G08_complete) / sizeof(FIBO_G08_complete[0]);

    if (IsCoordinatedMoveComplete() && (HAL_GetTick() - last_move_time > 10000)) {
        if (point_index < total_points) {
...
//	static uint32_t last_move_time = 0;
//	static uint8_t point_index = 0;
//	static const uint8_t total_points = sizeof(FIBO_G08_complete)
...
//		UpdateTuningParameters(25.575f, 0.0755f, 2.5f, 0.75f, 0.015f, 0.0f);  //pris
	...
	UpdateRevoluteTuningParameters(30.0f, 0.02f, 2.5f, 0.43f, 0.041f, 0.0f);
...
//	UpdatePrismaticTuningParameters(25.575f, 0.0755f, 2.8f, 1.2f, 0.6f, 0.0f);
	UpdatePrismaticTuningParameters(53.0f, 0.03f, 4.0f, 0.43f, 0.041f, 0.0f);
...
//		}
		if (main_servo == 1) {
			...
			__HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_2, PWM_set);
		}
...
void TestCoordinatedMovementFixed(void) {
	...
	static CoordPosition coord_positions[] = { { 0.0f, 0.0f },   // Both at zero
			...
			{ M_PI / 6.0f, -M_PI / 6.0f }                 // Both return to zero
	};
...
void MoveToCoordinatedPositionSynced(float revolute_target,
	...
	float revolute_velocity = revolute_distance / (sync_time * 0.8f); // 0.8 factor for trapezoidal profile
	float prismatic_velocity = prismatic_distance / (sync_time * 0.8f);

	SetTrajectoryParameters(&revolute_trajectory, revolute_velocity, 0.4f);
	SetTrajectoryParameters(&prismatic_trajectory, prismatic_velocity, 0.4f);
